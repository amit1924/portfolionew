    ...
    <div className="projects-container" id="pj">
      ...
      <div className="project-card">
        ...
        <p className="project-description">
          This project i made by using React components by using
          css,html and jvascript
        </p>
        <a
      ...
      <div className="project-card">
        ...
        <p className="project-description">
         i made this small website by using nextjs 13
         its about fetching API
      ...
      <div className="project-card">
        ...
        <p className="project-description">
         i made this small project to just show 
         the skills to use backend and 'frontend tool'
        </p>
        <a
      ...
      <div className="project-card">
        <h2>Weather API</h2>
        <p className="project-description">
         This is very small project made by using
